...
```bash
git clone [<repository_url>](https://github.com/atomsis/VC.git)
```
--------------------------------------------
Если планируете запускать не через контейнер
--------------------------------------------
2.without_docker. pip install -r requirements.txt
--------------------------------------------
...
- Погодные данные предоставлены [поставщиком погодного API](WeatherAPI.com).
- Визуализация в виде круговой диаграммы вдохновлена [источником](alfabank).
